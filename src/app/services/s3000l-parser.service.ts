 ...
 * ============================================================================
 * 
 * // TODO: [INTÉGRATION BACKEND / CLOUD STORAGE]
 * // Pour brancher votre backend en production :
 * // 1. Injecter HttpClient : private http = inject(HttpClient);
 * // 2. Remplacer loadSampleData() par un appel GET :
 * //    this.http.get<S3000LTreeNode>(`/api/v1/projects/${projectId}/breakdown`)
 * // 3. Uploader les fichiers XML réels :
 * //    const formData = new FormData(); formData.append('file', file);
 * //    this.http.post<S3000LTreeNode>('/api/v1/s3000l/parse', formData)
 */
@Injectable({
  providedIn: 'root'
})
